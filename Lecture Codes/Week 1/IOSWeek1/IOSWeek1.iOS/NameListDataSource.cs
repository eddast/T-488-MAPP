...
namespace IOSWeek1.iOS
{
    public class NameListDataSource : UITableViewSource
    {
        ...
        public NameListDataSource( List<string> nameList ) { this._nameList = nameList; }
        ...
        public override nint RowsInSection(UITableView tableview, nint section) { return this._nameList.Count; }
    }
}